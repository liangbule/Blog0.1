...
module.exports = {
  ...
  */
  head: {
    // title: '不才的博客',
    titleTemplate: (title) => {
      return title ? `${title} - 凉不乐的博客` : '凉不乐的博客'
    },
    htmlAttrs: {
      lang: undefined
    },
    meta: [
      ...
      { hid: 'description', name: 'description', content: '这是凉不乐的博客，用于记录生活、学习笔记。专注WEB前端，全面发展，做一个有梦想又憨憨的咸鱼。网站内容不定期更新，欢迎大家关注，共同交流进步。' },
      { hid: 'keywords', name: 'keywords', content: "个人博客,凉不乐,凉不乐的博客,前端,web,javascript,vue,react,nodejs,凉不乐 Blog,bucai,blog" }
    ],
    link: [
