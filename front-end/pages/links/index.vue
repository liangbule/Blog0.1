<!--
 * @Author: liangbule
 * @Date: 2021-08-28 14:07:08
 * @LastEditors: liangbule
 * @LastEditTime: 2021-08-29 00:43:07
 * @Description: 
-->
<template>
    ...
    <v-card>
      <v-container class="body-2">
        <div>
          ...
          <a href="mailto:576865892@qq.com">576865892@qq.com</a>
        </div>
        <div>
          <div style="margin: 8px 0px;">
            ...
            <div>
              博客地址:
              <a href="https://www.liangbule.com">https://www.liangbule.com</a>
            </div>
            <div>博客简介: 凉不乐</div>
            <div style="overflow-wrap: break-word;">
              博客头像:
              <a
                href="https://image.liangbule.com/logo.png"
                target="_blank"
              >https://image.liangbule.com/logo.png</a>
            </div>
          </div>
          <v-divider></v-divider>
          <div style="margin-top: 10px;">
            ...
            <div class="caption font-italic">2021-08-30</div>
          </div>
        </div>
      </v-container>
    </v-card>
...
export default {
  ...
  async asyncData ({ isDev, route, store, env, params, query, req, res, redirect, error, $axios }) {
    ...
    const links = [{
      logo:'https://image.notbucai.com/logo.png',
      url:'https://www.liangbule.com',
      title:'凉不乐',
      intro:'始于前方'
    }]
    console.log('links',links.logo);
    return {
      links
    }
  },
